***GUIDELINES***
1. Put all unorganized functions that into Prototypes,  this includes code that is not adjusted for the main arduino file.  For example, your code would still contain a a setup and loop.
