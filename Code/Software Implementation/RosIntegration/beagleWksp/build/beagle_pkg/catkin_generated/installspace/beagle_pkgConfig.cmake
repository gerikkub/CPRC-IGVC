...
if(NOT "include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'beagle_pkg' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/daschulz/IGVC/beagleWksp/install/${idir}'.  Ask the maintainer 'daschulz <daschulz@calpoly.edu>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/daschulz/IGVC/beagleWksp/install/lib;/home/daschulz/IGVC/beagleWksp/devel/lib;/opt/ros/hydro/lib)
